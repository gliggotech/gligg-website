  ...
  return (
    <div className=" rounded-xl">
      <motion.div
        ...
        className="flex flex-col gap-y-5 items-center shadow-dark_shadow hover:shadow-dark_shadow_hover  justify-center 2xl:max-w-2xl xl:max-w-xl md:max-w-md h-auto bg-black rounded-2xl  p-5 lg:p-10 sm:rounded-xl font-Questrial text-white group"
